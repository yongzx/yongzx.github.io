...
My current focus is on **scaling reasoning compute**. My most recent work shows that [test-time scaling makes English models reason well in crosslingual settings](https://arxiv.org/abs/2505.05408). More work to come soon :)
