...
- **Generalization of test-time thinking.** My most recent work characterizes test-time scaling of reasoning language models transfers across languages and domains. We observe effective crosslingual generalization from English reasoning finetuning due to the "quote-and-think" pattern but limited cross-domain generalization from math domain [(preprint)](https://arxiv.org/abs/2505.05408).
