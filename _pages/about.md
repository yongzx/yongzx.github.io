...
My current focus is on **test-time scaling and reasoning language models**. My most recent work is about how [scaling up thinking tokens can improve crosslingual reasoning performance](https://arxiv.org/abs/2505.05408). More work to come soon :)
